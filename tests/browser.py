...
with sync_playwright() as p:
    ...
    try:
        ...
        def authoring_surfaces():
            expect("counterform.commands.commands.size===145 && counterform.menuDefinitions.length===9")
        ...
        check('all 145 commands are available through nine menus and 24 vector tool buttons',authoring_surfaces)
        def menu_keyboard():
