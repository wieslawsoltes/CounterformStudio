...
with sync_playwright() as p:
    ...
    try:
        ...
        def text_keys():
            ...
            js("counterform.dock.Find('library').Hide();counterform.activate('glyph')")
        ...
        from color_browser import qualify_color
        qualify_color(page,js,expect,check,out,report)
        def metrics():
        ...
        def authoring_surfaces():
            expect("counterform.commands.commands.size===152 && counterform.menuDefinitions.length===9")
        ...
        check('all 152 commands are available through nine menus and 24 vector tool buttons',authoring_surfaces)
        def menu_keyboard():
