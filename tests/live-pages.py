...
def main() -> None:
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            check('deployed authoring surface contains 24 tools, nine menus and 130 commands', environment['tools']==24 and environment['menus']==9 and environment['commands']==130)
