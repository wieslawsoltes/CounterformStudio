...
with sync_playwright() as pw:
    ...
    try:
        ...
        def reachability():
            condition("counterform.commands.commands.size===157&&counterform.menuDefinitions.length===9")
        ...
        check('all 157 commands remain reachable; three authoring tools join existing menus',reachability)
        def validate_only():
