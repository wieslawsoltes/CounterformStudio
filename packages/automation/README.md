# @wieslawsoltes/counterform-automation

Declarative, bounded font transformation recipes without arbitrary code execution.
...
```sh
npm install ./wieslawsoltes-counterform-automation-0.1.0.tgz
```
