# @wieslawsoltes/counterform-commands

Scoped keyboard routing, command palette search, enablement and configurable shortcuts.
...
```sh
npm install ./wieslawsoltes-counterform-commands-0.1.0.tgz
```
