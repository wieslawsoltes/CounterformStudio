# @wieslawsoltes/counterform-validation

Font geometry, encoding, feature, topology and component graph diagnostics.
...
```sh
npm install ./wieslawsoltes-counterform-validation-0.1.0.tgz
```
