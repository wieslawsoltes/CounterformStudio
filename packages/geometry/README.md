...
```sh
npm install ./wieslawsoltes-counterform-geometry-0.8.0.tgz
```
...
Complete SVG path command parsing and elliptical-arc cubic conversion: fromSVG, parseSVGPath and arcToCubics. See `docs/UNICODE-SVG-INTERCHANGE.md` in the repository for limits and verification.
