# @wieslawsoltes/counterform-proofing

Compiled-font live proofing via browser FontFace and OpenType shaping.
...
```sh
npm install ./wieslawsoltes-counterform-proofing-0.1.0.tgz
```
