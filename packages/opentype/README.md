# @wieslawsoltes/counterform-opentype

Strict OpenType feature parsing and GSUB, GPOS, GDEF and kerning table compilation.
...
```sh
npm install ./wieslawsoltes-counterform-opentype-0.8.0.tgz
```
...
0.6.0 adds static cursive/base/ligature/mark-to-mark FEA attachments, named anchors, mark classes, subtable grouping, MarkAttachmentType and UseMarkFilteringSet. Existing variable positioning stores are retained in GDEF. Device/variable FEA anchors are outside this release.
