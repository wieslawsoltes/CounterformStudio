# @wieslawsoltes/counterform-history

Atomic glyph-scoped and font-scoped undo/redo transactions with bounded history.
...
```sh
npm install ./wieslawsoltes-counterform-history-0.1.0.tgz
```
