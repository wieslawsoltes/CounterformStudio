...
export function menuDefinitions(registry){
 const definitions=[
  ...
  {label:'Font',items:['font.info','glyph.new','master.add','axis.add','axis.map','master.instance','master.compatibility','master.metrics',null,'metrics.editor','kern.pair','kern.groups','color.paint','color.bitmap','color.edit','features.apply','features.attachments','features.variations',null,'font.validate','font.tables']},
  {label:'Glyph',items:['glyph.new','glyph.duplicate','glyph.delete','glyph.previous','glyph.next','glyph.variations',null,'glyph.center','glyph.anchor','glyph.guides','glyph.clearGuides','glyph.lock',null,'glyph.artwork','glyph.autotrace','glyph.mask',null,'glyph.component','glyph.decompose']},
  {label:'Contour',items:['node.smooth','node.corner','node.start','outline.extrema',null,'outline.join','outline.open','outline.close','outline.reverse','outline.winding',null,'outline.lines','outline.curves','outline.clean','outline.fit','outline.round','outline.analyze','outline.modifiers','outline.bake',null,'outline.overlap','outline.union','outline.difference','outline.intersect','outline.xor','outline.stroke',null,'outline.transform','outline.mirrorX','outline.mirrorY','node.alignX','node.alignY','node.distributeX','node.distributeY']},
