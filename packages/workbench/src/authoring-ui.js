...
export const ribbonTabs=[
 ...
 {id:'masters',label:'Masters',groups:[{id:'masters',label:'Design space',commands:['view.masters','master.add','axis.add','master.compatibility','master.instance','master.metrics']},{id:'components',label:'Components',commands:['glyph.component','glyph.decompose','outline.modifiers','outline.bake']}]},
 {id:'opentype',label:'OpenType',groups:[{id:'compile',label:'Compilation',commands:['view.features','features.apply','font.validate','font.tables']},{id:'color',label:'Color & attachment',commands:['color.paint','color.edit','glyph.anchor','glyph.guides']},{id:'export',label:'Production',commands:['file.export','file.metadataExport','glyph.svg']}]},
...
export function menuDefinitions(registry){
 const definitions=[
  {label:'File',items:['file.new','file.open','file.recent',null,'file.save','file.export','file.original','file.metadataExport','file.recovery','glyph.svg',null,'file.demo']},
  ...
  {label:'Font',items:['font.info','glyph.new','master.add','axis.add','master.instance','master.compatibility','master.metrics',null,'kern.pair','kern.groups','color.paint','color.edit','features.apply',null,'font.validate','font.tables']},
  ...
  {label:'Contour',items:['node.smooth','node.corner','node.start','outline.extrema',null,'outline.join','outline.open','outline.close','outline.reverse','outline.winding',null,'outline.lines','outline.curves','outline.clean','outline.round','outline.modifiers','outline.bake',null,'outline.overlap','outline.union','outline.difference','outline.intersect','outline.xor','outline.stroke',null,'outline.transform','outline.mirrorX','outline.mirrorY','node.alignX','node.alignY','node.distributeX','node.distributeY']},
