...
export const ribbonTabs=[
 ...
 {id:'opentype',label:'OpenType',groups:[{id:'compile',label:'Compilation',commands:['view.features','features.apply','font.validate','font.tables']},{id:'color',label:'Color & attachment',commands:['color.edit','glyph.anchor','glyph.guides']},{id:'export',label:'Production',commands:['file.export','file.metadataExport','glyph.svg']}]},
...
export function menuDefinitions(registry){
 const definitions=[
  ...
  {label:'Font',items:['font.info','glyph.new','master.add','axis.add','master.instance','master.compatibility','master.metrics',null,'kern.pair','kern.groups','color.edit','features.apply',null,'font.validate','font.tables']},
