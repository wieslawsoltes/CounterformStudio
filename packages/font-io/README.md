# @wieslawsoltes/counterform-font-io

TrueType/CFF OpenType compilation, WOFF containers and bounded font import.
...
```sh
npm install ./wieslawsoltes-counterform-font-io-0.2.0.tgz
```
