# @wieslawsoltes/counterform-integrations

ReactiveWeb, DynamicDataWeb, RibbonWeb, TreeDataGridWeb, GridWeb and RichTextWeb adapters.

Version **0.2.0**. ES modules with TypeScript declarations. No application-global singleton is required by the pure authoring engines. The renderer/editor/workbench packages require a browser DOM.

## Install

```sh
npm install ./wieslawsoltes-counterform-integrations-0.2.0.tgz
```
