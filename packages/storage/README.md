# @wieslawsoltes/counterform-storage

IndexedDB font projects, debounced autosave and browser project file I/O.
...
```sh
npm install ./wieslawsoltes-counterform-storage-0.1.0.tgz
```
