# @wieslawsoltes/counterform-editor

Pointer and keyboard Bézier editing with RBush picking and atomic undo transactions.
...
```sh
npm install ./wieslawsoltes-counterform-editor-0.1.0.tgz
```
