...
var equation_structure_exports = {};
__export(equation_structure_exports, {
  deleteEquationToken: () => deleteEquationToken,
  editEquationMatrix: () => editEquationMatrix,
  equationMatrixAt: () => equationMatrixAt,
  insertEquationToken: () => insertEquationToken,
  mathMLToLaTeX: () => mathMLToLaTeX
});
module.exports = __toCommonJS(equation_structure_exports);
...
function rootOf(source) {
  return (0, import_formats_markup.parseMarkup)((0, import_equations.sanitizeMathML)(source), true).children[0];
}
...
function editEquationMatrix(source, path, operation) {
  ...
  return (0, import_equations.sanitizeMathML)((0, import_equations.serializeMathNode)(root));
}
...
function mathMLToLaTeX(source) {
  ...
  const convert = (n) => {
    ...
    switch (n.name) {
      ...
      case "mo":
      case "mtext": {
        const text = (0, import_formats_markup.textContent)(n);
      ...
      case "munder": {
        ...
        const mark = marks[(0, import_formats_markup.textContent)(children[1])];
