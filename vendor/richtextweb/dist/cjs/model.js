...
__export(model_exports, {
  ...
  DependencyPropertyHelper: () => DependencyPropertyHelper,
  DependencyPropertyKey: () => DependencyPropertyKey,
  Equation: () => Equation,
  EventDispatcher: () => EventDispatcher,
  Figure: () => Figure,
  FigureHorizontalAnchor: () => FigureHorizontalAnchor,
  FigureLength: () => FigureLength,
  FigureUnitType: () => FigureUnitType,
  FigureVerticalAnchor: () => FigureVerticalAnchor,
  Floater: () => Floater,
  ...
  FrameworkPropertyMetadataOptions: () => FrameworkPropertyMetadataOptions,
