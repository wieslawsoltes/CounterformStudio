...
import { pageAtOffset as pageAtOffset2, pagePreviewWindow as pagePreviewWindow2 } from "./page-window.js";
...
import { DocumentVirtualizer as DocumentVirtualizer2 } from "./virtualization.js";
import { normalizeFloatingLayout as normalizeFloatingLayout2 } from "./floating-layout.js";
...
class RichTextBox extends HTMLElementBase {
  ...
  _virtualizer = new DocumentVirtualizer();
  _virtualWindow = null;
  ...
  async Copy() {
    ...
    const html = toHTML(this.Engine.GetSelectedFragment()), text = this.Selection.Text;
...
class FlowDocumentPageViewer extends FlowDocumentReader {
  ...
  configurePagination() {
    ...
    if (!unchanged)
      applyEffectiveStyleValues(json, this.Document, void 0, false);
...
${override}</style></head><body>${body}</body></html>`;
  ...
  renderStories() {
    ...
    const variant = (kind) => props[pageStoryKey(props, kind, this.PageNumber)] || [];
        ...
        copy.children = [
          {
            ...
            props: {},
            text: String(
              type === "PAGE" ? documentPageNumber(props, this.PageNumber) : this.PageCount
            )
          }
        ];
      return copy;
...
export {
  DocumentVirtualizer2 as DocumentVirtualizer,
  FlowDocumentPageViewer,
  FlowDocumentReader,
  FlowDocumentScrollViewer,
  RichTextBox,
  RichTextPageEditor,
  normalizeFloatingLayout2 as normalizeFloatingLayout,
  pageAtOffset2 as pageAtOffset,
  pagePreviewWindow2 as pagePreviewWindow,
  registerRichTextWeb
};
