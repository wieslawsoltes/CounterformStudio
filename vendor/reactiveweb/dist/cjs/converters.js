...
__export(converters_exports, {
  BindingFallbackConverterRegistry: () => FallbackConverterRegistry,
  BindingTypeConverter: () => BindingTypeConverter,
  BindingTypeConverterRegistry: () => TypedConverterRegistry,
  Conversion: () => Conversion,
  ConverterService: () => ConverterService,
  DateToStringConverter: () => DateToStringConverter,
  EqualityTypeConverter: () => EqualityTypeConverter,
  FallbackConverterRegistry: () => FallbackConverterRegistry,
  ...
  PropertyBindingHookRegistry: () => PropertyBindingHookRegistry,
  RegisterDefaultConverters: () => RegisterDefaultConverters,
  RxConverters: () => RxConverters,
  SetMethodBindingConverterRegistry: () => SetMethodConverterRegistry,
  SetMethodConverterRegistry: () => SetMethodConverterRegistry,
  ...
  TypedConverterRegistry: () => TypedConverterRegistry
});
...
const Conversion = Object.freeze({
  Success(value) {
    return { Success: true, Result: value, success: true, value };
  },
  Failure(error) {
    return { Success: false, success: false, Error: error };
  }
});
class BindingTypeConverter {
  ...
  TryConvert(value, hint) {
    return this.TryConvertTyped(value, hint);
  }
}
class Registry {
  registrations = [];
  Register(converter) {
    ...
    const entry = { value: converter, identity: /* @__PURE__ */ Symbol() };
  ...
  GetAllConverters() {
    return this.registrations.map((entry) => entry.value);
  }
  Clear() {
...
class TypedConverterRegistry extends Registry {
...
class FallbackConverterRegistry extends Registry {
  TryGetConverter(fromType, toType) {
    return this.highest((converter) => converter.GetAffinityForObjects(fromType, toType));
  }
}
class SetMethodConverterRegistry extends Registry {
  TryGetConverter(fromType, toType) {
    return this.highest((converter) => converter.GetAffinityForObjects(fromType, toType));
  }
}
function GetBindingType(value) {
...
class ConverterService {
  static current;
  static get Current() {
    return this.current ??= new ConverterService();
  }
  ...
  constructor(registerDefaults = true) {
    if (registerDefaults) RegisterDefaultConverters(this);
  }
  ...
  ResolveSetMethodConverter(fromType, toType) {
    return this.SetMethodConverters.TryGetConverter(fromType, toType);
  }
...
class StringConverter {
  GetAffinityForObjects(fromType, toType) {
    return toType === String && [String, Number, Boolean, BigInt, "null", "undefined"].includes(fromType) ? 1 : 0;
  }
...
class StringToNumberConverter extends BindingTypeConverter {
  constructor() {
...
class NumberToStringConverter extends BindingTypeConverter {
  constructor() {
    super(Number, String, (value) => Number.isFinite(value) ? Conversion.Success(String(value)) : Conversion.Failure(new TypeError("Expected a finite number.")));
  }
}
class StringToBooleanConverter extends BindingTypeConverter {
  constructor() {
...
class NumberToBooleanConverter extends BindingTypeConverter {
  constructor() {
    super(Number, Boolean, (value) => value === 1 ? Conversion.Success(true) : value === 0 ? Conversion.Success(false) : Conversion.Failure(new TypeError("Expected 0 or 1.")));
  }
}
class StringToDateConverter extends BindingTypeConverter {
  constructor() {
...
class DateToStringConverter extends BindingTypeConverter {
  constructor() {
    super(Date, String, (value) => value instanceof Date && Number.isFinite(value.getTime()) ? Conversion.Success(value.toISOString()) : Conversion.Failure(new TypeError("Expected a valid Date.")));
  }
}
function RegisterDefaultConverters(service) {
...
class PropertyBindingHookRegistry {
  ...
  ExecuteHooks(context) {
    return [...this.hooks.values()].every((hook) => hook.ExecuteHook(context));
  }
}
class RxConverters {
  static get Services() {
    return ConverterService.Current;
  }
  static set Services(value) {
    ConverterService.Current = value;
  }
}
...
0 && (module.exports = {
  ...
  FallbackConverterRegistry,
  GetBindingType,
  NumberToBooleanConverter,
  NumberToStringConverter,
  PropertyBindingHookRegistry,
  RegisterDefaultConverters,
  RxConverters,
  SetMethodBindingConverterRegistry,
  SetMethodConverterRegistry,
  StringConverter,
  StringToBooleanConverter,
  StringToDateConverter,
  StringToNumberConverter,
  TypedConverterRegistry
});
